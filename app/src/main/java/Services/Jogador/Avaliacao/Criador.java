...
public class Criador {
    ...
    public static Promise execute (Activity activity, Jogador jogador, Review review) {
        ...
        HttpService.getInstance().post(activity, "/api/players/"+jogador.getId()+"/reviews", params, new JsonHttpResponseHandler() {
            @Override
